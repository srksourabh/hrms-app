...
export function Header({ user, onOpenMenu }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[72px] items-center gap-3 border-b border-slate-200/80 bg-[#f7f7f4]/90 px-4 backdrop-blur-xl sm:px-6">
      ...
      <Link href="/search" className="group hidden h-11 min-w-0 max-w-md flex-1 items-center gap-3 rounded-full border border-slate-200 bg-white px-4 text-sm text-slate-400 transition hover:border-emerald-800/25 hover:text-slate-700 sm:flex">
